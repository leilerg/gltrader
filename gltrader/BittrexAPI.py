...
class BittrexAPI(object):
    ...
    def trade_sell(self, market=None, order_type=None, quantity=None, rate=None, time_in_effect=None,
        ...
        #         TIMEINEFFECT_IMMEDIATE_OR_CANCEL = 'IMMEDIATE_OR_CANCEL', or
        #         TIMEINEFFECT_FILL_OR_KILL = 'FILL_OR_KILL'  
        # :type time_in_effect: str
        # :param condition_type: CONDITIONTYPE_NONE = 'NONE',
        ...
        #=======================================================================
        self.ApiCalls = self.ApiCalls + 1
        return self.BittrexAPI_V2_0.trade_sell(market,
                                               order_type,
                                               quantity,
                                               rate,
                                               time_in_effect,
    ...
    def trade_buy(self, market=None, order_type=None, quantity=None, rate=None, time_in_effect=None,
        ...
        #=======================================================================
        self.ApiCalls = self.ApiCalls + 1
        return self.BittrexAPI_V2_0.trade_buy(market,
                                              order_type, 
                                              quantity, 
                                              rate, 
                                              time_in_effect, 
