...
class Notification(object):
    ...
    def getMessageValues(self):
        ...
        return {
            ...
            "api miss" : "API response missed",
            "NOTIFY_TRADE_ALERT"    : "Trade suggested!!!",
            "NOTIFY_NEW_MARKET"     : "Market was added for Monitoring",
            "NOTIFY_REMOVE_MARKET"  : "Market was removed from Monitoring",
            "API_RESPONSE_MISS"     : "API response missed"
        }
    ...
    def getObjects(self, kwargs):
        ...
        if self.sender:
            for base in inspect.getmro(self.sender.__class__):
                ...
                elif "MarketData" == base.__name__ or "MarketData" == self.sender.__class__.__name__:
                    self.market = self.sender.market
                    self.order = self.sender
...
class Success(Notification):
    ...
    def oneline(self):
        ...
        log.debug("==========Success: " + self.message + " ==========")
