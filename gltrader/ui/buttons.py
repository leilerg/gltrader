...
class NotificationScreenButton(Button):
    ...
    def __init__(self, **kwargs):
        super(NotificationScreenButton, self).__init__(**kwargs, text="Notifications Screen")
...
class TraderScreenButton(Button):
    ...
    #===========================================================================
    def __init__(self, **kwargs):
        super(TraderScreenButton, self).__init__(**kwargs, text="Trader Summary Screen")
        self.background_color = [.5,.5,.7,1]
...
class ActionDoButton(Button):
    ...
    def refresh(self):
        if(self.action.done):
            self.background_color = [.7,.7,.7,1]
            if(not self.action.checkActionComplete()):
...
class ClearAllNotificationsButton(Button):
   ...
   #===========================================================================
    ...
    def __init__(self, **kwargs):
        super(ClearAllNotificationsButton, self).__init__(text="Clear All")
        self.background_color = [1,.7,.7,1]
        self.color = [0,0,0,1]
    ...
    def on_release(self):
        ...
        for nID, noteRow in nlayout.rowWidgets.items():
            ...
            App.get_running_app().rootWidget.nScreen.notification_layout.remove_widget(noteRow)
        # nlayout.rowWidgets = {}
        App.get_running_app().on_resume()
