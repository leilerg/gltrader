...
class MarketRow(GridLayout):
    #===========================================================================
    # Responsible for displaying a single row of the market info table.  
    # Gets "getters" from MarketTableColumns and creates a dictionary of Labels from those getters
    #===========================================================================
    ...
    def __init__(self, market=None, **kwargs):
        ...
        super(MarketRow, self).__init__(**kwargs, rows=1, width=150)
    ...
    def refresh(self, obj=None, val=None):
        #=======================================================================
        # self.column is a dict of widgets.  
        # This either refreshes or adds each widget in the view when the dict is updated
        # 
    ...
    def delRefresher(self):
        self.app.rootWidget.refreshers.remove(self.refresh)
