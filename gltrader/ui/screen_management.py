...
class NotificationScreen(Screen):
    #===========================================================================
    # The screen widget which contains the main home notificstion layout
    #===========================================================================
    notification_layout = ObjectProperty()
    info_layout = ObjectProperty()
...
class ScreenManagement(ScreenManager):
    ...
    # Can be accessed via App.get_running_app().rootWidget (requires import kivy.App)  
    # Contains list of "refresher" functions which are executed each tick to update GUI elements
    #===========================================================================
    ...
    def refresh(self):
        ...
        # Update rows of market table
        # self.tScreen.updateMarketRows()       
        # App.get_running_app().rootWidget.tScreen.market_table.updateMarketRows()
        # MarketTable().updateMarketRows()
